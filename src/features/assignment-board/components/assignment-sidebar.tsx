...
import { StatusSelect, DEFAULT_STATUS_CONFIGS, type StatusConfig, cfgBadge, COLOR_OPTIONS } from "./status-select";
...
// ─── ActiveDeptSelect (local) ─────────────────────────────────────────────────

function ActiveDeptSelect({ activeDepartmentIds, workAreas, onChange }: {
